...
def get_transformer_24_24_grid():
    return [
        ...
        hyperparam('--encoder-ffn-embed-dim', 8 * 1024, save_dir_key=lambda val: f'encffnx{val}'),
        hyperparam('--decoder-ffn-embed-dim', 8 * 1024, save_dir_key=lambda val: f'decffnx{val}'),
