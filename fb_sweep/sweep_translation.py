...
def add_extra_options_func(parser):
    ...
    parser.add_argument('--source-lang', help='source language for translation', type=str)
    parser.add_argument('--target-lang', help='target language for translation', type=str)
...
def get_grid(args):
    ...
    grids = [
        ...
        hyperparam('--source-lang', args.source_lang, save_dir_key=lambda val: f'@{val}'),
        hyperparam('--target-lang', args.target_lang, save_dir_key=lambda val: f'@{val}'),

        hyperparam('--update-freq', args.update_freq,  save_dir_key=lambda val: f'up{val}'),
