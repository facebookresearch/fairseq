...
if __name__ == "__main__":
    ...
    # parser.add_argument('--pron', type=str) # pron.score
    ...
    # parser.add_argument('--p_scale', type=int, default = 1)
    ...
    # pron = [x.strip() for x in open(args.pron, "r").readlines()]
    ...
    #     score = float(x)
    #     if score == 0:
    #         pron_new.append(math.log(0.000000001))
    #     else:
    #         pron_new.append(math.log(score))
    # pron_new = []
    # for x in pron:
    #     if x == "":
    #         pron_new.append(-10000)
    #     else:
    #         score = float(x)
    #         pron_new.append(score)
    ...
    for i in range(args.iters):
        ...
        # p_w = np.random.rand() * p_scale
        if args.length_score == 1:
            le_w = (np.random.rand() -0.5) * 5
            weights.append([s_w, w_w, a_w, l_w, le_w])
        else:
            weights.append([s_w, w_w, a_w, l_w])
