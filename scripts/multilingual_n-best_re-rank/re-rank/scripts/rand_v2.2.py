...
if __name__ == "__main__":
    ...
    if args.norm != 0:
        ...
        slid_ext_new = normalize(slid_ext_new)
    ...
    for i in range(args.iters):
        ...
        if args.length_score == 1:
            ...
            weights.append([s_w, se_w, w_w, a_w, l_w, fm_w, fz_w, prisk_w, pref_w, le_w])
        else:
            weights.append([s_w, se_w, w_w, a_w, l_w, fm_w, fz_w, prisk_w, pref_w])
