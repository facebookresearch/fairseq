...
# login(token='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')
...
if __name__ == "__main__":
    ...
    base_model = AutoModelForCausalLM.from_pretrained('meta-llama/Llama-2-7b-hf')#.to("cuda")
    ...
    # res = []
    with open(args.dst + "/predictions.txt", "w", buffering=1) as f:
        for t in tqdm(txts):
            ...
            f.write(str(log_sum) + "\t" + str(length) + "\n")
