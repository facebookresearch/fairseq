...
if __name__ == "__main__":
    ...
    for l in langs:
        text_lines = open(l + "/text", "r").readlines()
        for t in text_lines:
            t_data = eval(t)
    ...
    with open(args.dump + "/all_wav.txt", "w") as f1, \
        open(args.dump + "/all.tsv", "w") as f2, \
        open(args.dump + "/all.label", "w") as f3, \
        open(args.dump + "/all.wrd", "w") as f4, \
        open(args.dump + "/all.ltr", "w") as f5:
        f2.write("/\n")
