...
if __name__ == "__main__":
    ...
    for i in range(args.splits):
        ...
        print(f"python scripts/infer_lid_corr_lang_prob.py --wavs {args.dst}/split_{str(i)}/wav.txt --lids {args.dst}/split_{str(i)}/lid.txt --dst {args.exp}/split_{str(i)} --model large-v2")