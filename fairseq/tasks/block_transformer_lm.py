...
from fairseq.data.mask_block_dataset import (
...
@register_task('block_transformer_lm')
class BlockTransformerLMTask(FairseqTask):
    """
    Train BERT model.
    ...
    def add_args(parser):
        ...
        parser.add_argument('--mask-ratio', default=0.60, type=float, help = 'total masked tokens')
        ...
        parser.add_argument('--geometric-p',default = -1.0, type=float, help='p for the geometric distribution used in span masking. -1 is uniform')
