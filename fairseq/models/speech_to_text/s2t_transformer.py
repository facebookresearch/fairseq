...
def lengths_to_encoder_padding_mask(lens):
...
class Conv1dSubsampler(nn.Module):
    def __init__(self, in_channels, mid_channels, out_channels,
        ...
        self.n_layers = len(self.kernel_sizes)
...
class S2TTransformerEncoder(FairseqEncoder):
    def __init__(self, args):
        ...
        self.subsample = Conv1dSubsampler(
            args.input_feat_per_channel * self.in_channels, args.conv_channels,
            args.encoder_embed_dim, args.conv_kernel_sizes
        )
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        encoder_padding_mask = lengths_to_encoder_padding_mask(input_lengths)
