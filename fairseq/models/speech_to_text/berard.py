...
class BerardModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--output-layer-dim", type=int, metavar="N",
...
@register_model_architecture(model_name="berard", arch_name="berard")
def berard(args):
    ...
    args.load_pretrained_encoder_from = getattr(args, "load_pretrained_encoder_from",
                                                None)
    args.load_pretrained_decoder_from = getattr(args, "load_pretrained_decoder_from",
                                                None)


@register_model_architecture(model_name="berard", arch_name="berard_256_3_3")
def berard_256_3_3(args):
    args.decoder_num_layers = getattr(args, "decoder_num_layers", 3)
    berard(args)


@register_model_architecture(model_name="berard", arch_name="berard_512_3_2")
...
@register_model_architecture(model_name="berard", arch_name="berard_f_512_3_2")
def berard_f_512_3_2(args):
    args.num_blstm_layers = getattr(args, "num_blstm_layers", 3)
    args.lstm_size = getattr(args, "lstm_size", 512)
    args.dropout = getattr(args, "dropout", 0.3)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 256)
...
@register_model_architecture(model_name="berard", arch_name="berard_512_5_3")
