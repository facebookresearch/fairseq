...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.alt_resid = utils.safe_getattr(cfg, "alt_resid", False)
        ...
        self.self_attn_layer_norm = LayerNorm(self.embed_dim * (2 if self.alt_resid and not self.normalize_before else 1))
        ...
        self.fc1 = self.build_fc1(
            self.embed_dim * (2 if self.alt_resid else 1),
            cfg.ffn_embed_dim,
            self.quant_noise,
            self.quant_noise_block_size,
        )
        ...
        self.final_layer_norm = LayerNorm(self.embed_dim * (2 if self.alt_resid and self.normalize_before else 1))
        self.need_attn = True
