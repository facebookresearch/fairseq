# noremap  Copyright (c) Facebook, Inc. and its affiliates.
#
...
@register_model('pointer_transformer')
class PointerTransformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def extract_features(
        ...
        **unused,
        ...
        for idx, layer in enumerate(self.layers):
            encoder_state = None
            if encoder_out is not None:  # enc out is param
                if self.layer_wise_attention:
