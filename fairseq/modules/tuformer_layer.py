...
from fairseq.modules import LayerNorm, TuckerheadAttention
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def build_self_attention(
        ...
        return TuckerheadAttention(
            ...
            ratio=cfg.decoder.ratio,
        )

    # todo delete the hard-coded value
    def build_encoder_attention(self, embed_dim, cfg):
        print("build_encoder_attention")
        return TuckerheadAttention(
            embed_dim,
            cfg.encoder.rank,
            dropout=cfg.attention_dropout,
