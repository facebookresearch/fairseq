...
class DeepSpeedTrainer(Trainer):
    ...
    def _build_optimizer(self):
        ...
        logger.info(type(list(param_groups)))
        logger.info(list(param_groups))
        optimizer = optim.build_optimizer(self.cfg.optimizer, list(param_groups))
    ...
    def _populate_ds_config(self, cfg, ds_config):
        ...
        micro_batch_size = self._get_config(ds_config, "train_micro_batch_size_per_gpu", self.cfg.dataset.max_tokens // self.cfg.task.tokens_per_sample)
