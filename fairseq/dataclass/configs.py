...
class CommonConfig(FairseqDataclass):
    ...
    aim_repo: Optional[str] = field(
        default=None, metadata={"help": "path to Aim repository"},
    )
    ...
    wandb_log_dir: Optional[str] = field(
        default=None,
...
class OptimizationConfig(FairseqDataclass):
    ...
    quant_method: QUANT_METHOD_CHOICES = field(
        default="none", metadata={"help": "type of quantization"}
    )
...
class GenerationConfig(FairseqDataclass):
    ...
    beam_mt: int = field(
        default=0, metadata={"help": "beam size for the first-pass decoder"},
    )
    nbest: int = field(
    ...
    eos_token: Optional[str] = field(
        default=None, metadata={"help": "EOS token"},
    )
