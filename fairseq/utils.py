...
def parse_alignment(line):
    ...
    params:
    line (str): String containing the alignment of the format <src_idx_1>-<tgt_idx_1> <src_idx_2>-<tgt_idx_2> .. <src_idx_m>-<tgt_idx_m>. All indices being 0 indexed.
    returns:
    torch.IntTensor of shape (2 * m) packing the alignments.
    """
