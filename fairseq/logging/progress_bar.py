...
def progress_bar(
    ...
    if wandb_project:
        bar = WandBProgressBarWrapper(
            bar, wandb_project, run_name=wandb_run_name, log_dir=wandb_log_dir
        )
...
class WandBProgressBarWrapper(BaseProgressBar):
    ...
    def __init__(self, wrapped_bar, wandb_project, run_name=None, log_dir=None):
        self.wrapped_bar = wrapped_bar
        if wandb is None:
        ...
        wandb.init(project=wandb_project, reinit=False, name=run_name, dir=log_dir)
