...
mdl="03_f1_ep30"
pretrained_encoder = "/checkpoint/mgaido/2022/ne/stmulti_fn.dualinputs2twavtransformer_base_stack.adam.lr0.0003.uf4.cn10.0.wu20000.gal0.8.car0.02.egm2.0.ls0.1.mst8000.0k.msp660.0k.mtt8.192k.03_f1_ep30.mcl64.mcp0.5.mcl10.mcp0.65.ssr0.15.mtr0.0.random.ticr0.5.config_st.lne.ngpu8/avg10.pt"
...
def get_grid(args):
    ...
    return [
        ...
        hyperparam('--finetune-from-model', '/checkpoint/mgaido/2022/ne/er_st_marginrank.dual_input_er_transformer_base_stack.adam.lr0.0003.uf4.cn10.0.wu20000.neg1.margin1.0.egm2.0.mst8000.0k.msp800.0k.config_st.lne.ngpu8/checkpoint_best.pt', save_dir_key=lambda val: f'rf_{get_filename_wo_ext(val)}'),
        ...
        hyperparam('--lr', [ 0.0001 ], save_dir_key=lambda val: f'lr{val}'),     #learn rate to s2t
