...
mdl="03_f1_ep30"
pretrained_encoder = "/checkpoint/mgaido/2022/ne/asr_fn.dualinputs2twavtransformer_base_stack.adam.lr0.0003.uf4.cn10.0.wu20000.gal0.8.car0.02.egm2.0.ls0.1.mst8000.0k.msp660.0k.mtt8.192k.03_f1_ep30.mcl64.mcp0.5.mcl10.mcp0.65.ssr0.15.mtr0.3.random.ticr0.5.config_asr.lne.ngpu8/avg10.pt"
...
def get_grid(args):
    ...
    return [
        ...
        hyperparam('--train-subset', 'train_mustc_ph_es_asr,train_ep_ph_es_asr'),
        hyperparam('--valid-subset', 'dev_ep_ph_es_asr'),
        hyperparam('--config-yaml', 'config_asr.yaml', save_dir_key=lambda val: f'{get_filename_wo_ext(val)}'),
