...
def get_grid(args):
    ...
    return [
        ...
        hyperparam('--er-do-layerdrop'),
        hyperparam('--er-modality-embedding'),
        hyperparam('--noise-token', "▁NOISE"),
        hyperparam('--er-window-attention-mask'),
        hyperparam('--max-words', 5, save_dir_key=lambda val: f'mw{val}'),
        ...
        hyperparam('--train-subset', 'train_mustc_ph_es_st_with_entities,train_ep_ph_es_st_with_entities'),
        hyperparam('--valid-subset', 'dev_ep_ph_es_st_with_entities'),
