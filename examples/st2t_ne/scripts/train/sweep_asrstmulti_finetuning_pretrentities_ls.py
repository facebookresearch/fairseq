...
def get_grid(args):
    ...
    return [
        ...
        hyperparam('--langpairs', 'ph-en,ph-es,ph-fr,ph-it'),

        hyperparam('--max-tokens-valid', 800000),
        hyperparam('--ddp-backend', 'no_c10d'),
        hyperparam('--log-interval', 100),
        hyperparam('--train-subset', 'train_mustc_ph_es_asr,train_ep_ph_es_asr,train_mustc_ph_it_st,train_ep_ph_it_st,train_mustc_ph_es_st,train_ep_ph_es_st,train_mustc_ph_fr_st,train_ep_ph_fr_st'),
        hyperparam('--valid-subset', 'dev_ep_ph_it_st,dev_ep_ph_fr_st,dev_ep_ph_es_st,dev_ep_ph_es_asr'),
