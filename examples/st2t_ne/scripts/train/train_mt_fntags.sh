...
save_dir=/checkpoint/mgaido/2022/ne/mt/fntags_multilang
mkdir -p $save_dir
# 4 GPU
fairseq-train /large_experiments/ust/mgaido/2022/data/mt/fn/ \
    ...
    --arch multilingual_transformer_with_tags_iwslt_de_en --restore-file /checkpoint/mgaido/2022/ne/mt/base_multilang/avg10.pt \
