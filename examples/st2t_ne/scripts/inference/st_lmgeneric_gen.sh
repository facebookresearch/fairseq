...
for l in es fr it ; do
  for w in 0.05 0.1 0.15 0.2 ; do
    python /private/home/mgaido/fairseq/fairseq_cli/generate.py /large_experiments/ust/mgaido/2022/data/joint_s2t/st/ \
      ...
      --lm-is-class-based --lm-path /checkpoint/mgaido/2022/ne/lm/$l/avg10_best.pt:/checkpoint/mgaido/2022/ne/generic_lm/$l/fn/avg5_best.pt --lm-weight $w \
      --path $st_folder/avg10.pt --results-path $st_folder/test_ep_avg10_lmplusgeneric_$w
  done
done
