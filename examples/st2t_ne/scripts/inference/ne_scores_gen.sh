...
python /private/home/mgaido/fairseq/examples/speech_text_joint_to_text/scripts/entity_retrieval_scores.py /large_experiments/ust/mgaido/2022/data/joint_s2t/st \
  ...
  --list-candidates /private/home/mgaido/models/improvin_speech_translation/en-es/list_all.ph \
  --scores-activation-function sigmoid \
  --path /checkpoint/mgaido/2022/ne/$folder_name/avg5.pt --results-path /checkpoint/mgaido/2022/ne/$folder_name/scores_all_test_ep_${l}.pickle
...
python /private/home/mgaido/fairseq/examples/speech_text_joint_to_text/scripts/sym_scores_analysis.py \
  ...
  --outputfig /checkpoint/mgaido/2022/ne/$folder_name/en${l}_all_recall.png \
  --list-candidates /private/home/mgaido/models/improvin_speech_translation/en-es/list_all.txt \
  --lang en > /checkpoint/mgaido/2022/ne/$folder_name/recall_all_${l}.log 2>&1
