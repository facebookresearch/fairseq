...
declare -A tasks
tasks[cola]="/fsx-wav2vec/wnhsu/data/data2vec2/data/text/GLUE_chr/CoLA-bin"
tasks[qnli]="/fsx-wav2vec/wnhsu/data/data2vec2/data/text/GLUE_chr/QNLI-bin"
tasks[mrpc]="/fsx-wav2vec/wnhsu/data/data2vec2/data/text/GLUE_chr/MRPC-bin"
tasks[rte]="/fsx-wav2vec/wnhsu/data/data2vec2/data/text/GLUE_chr/RTE-bin"
tasks[sst_2]="/fsx-wav2vec/wnhsu/data/data2vec2/data/text/GLUE_chr/SST-2-bin"
