...
def gen_s2u_manifest(
    aud_ids, nframes, aud_paths, units, s2u_manifest_fn
):
    """
...
def gen_asr_manifest(
    aud_ids, units, asr_manifest_fn
):
    """
    ground truth units are given
    """
    ...
    data_dict = {
        "id": aud_ids,
        "tgt_text": [dedup_unit(unit) for unit in units]
    }
