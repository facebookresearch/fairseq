...
def gen_valid_data_manifest(
    ...
    gen_s2u_manifest(
        aud_ids, nframes, aud_paths, tgt_units, s2u_manifest
    )
    gen_asr_manifest(
        aud_ids, src_units, asr_manifest
    )
