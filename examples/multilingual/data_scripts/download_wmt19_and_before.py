...
wmt14_de_fr_en = DLDataset(
    ...
    valid_urls=[("http://www.statmt.org/wmt14/dev.tgz", "wmt14_dev.tgz"),],
    test_urls=[
        (
...
wmt17_fi_lv_tr_zh_en = DLDataset(
    ...
    valid_files_patterns=[
        ...
        (
            ...
            ["fi-en", "tr-en", "en-fi", "en-tr",],
        ),
    ],
    test_files_patterns=[
        (
            "test/newstest2017-{src}{tgt}-{src:src}{tgt:ref}.{lang}",
            ["fi-en", "lv-en", "tr-en", "en-fi", "en-lv", "en-tr",],
        ),
...
if __name__ == "__main__":
    ...
    work_on_wmt(
        ["ro_RO-en_XX", "en_XX-ro_XX"], wmt16_ro_en,
    )
    work_on_wmt(
        [
            # 'zh_CN-en_XX',
