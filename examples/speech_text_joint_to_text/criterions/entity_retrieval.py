...
@dataclass
class EntityRetrievalCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "entity_retrieval", dataclass=EntityRetrievalCriterionConfig
)
class EntityRetrievalCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        label_smoothing,
