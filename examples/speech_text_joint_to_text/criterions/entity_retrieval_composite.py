...
@dataclass
class EntityRetrievalCompositeCriterionConfig(FairseqDataclass):
...
@register_criterion(
    "entity_retrieval_composite", dataclass=EntityRetrievalCompositeCriterionConfig
)
class EntityRetrievalCompositeCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        label_smoothing,
