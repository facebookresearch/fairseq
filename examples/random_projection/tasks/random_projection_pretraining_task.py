...
from ..data.random_projection_dataset import FbankDataset, BinarizedFbankDataset, FileFbankDataset
...
@register_task("rp_pretraining", dataclass=AudioPretrainingConfig)
class RPPretrainingTask(FairseqTask):
    """ """
    ...
    def load_dataset(self, split: str, task_cfg: FairseqDataclass = None, **kwargs):
        ...
        if getattr(task_cfg, "binarized_dataset", False):
            self.datasets[split] = BinarizedFbankDataset(
                data_path,
                split=split,
            ...
            self.datasets[split] = FileFbankDataset(
